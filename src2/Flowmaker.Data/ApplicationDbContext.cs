...
namespace Flowmaker.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        public DbSet<Entities.Environment> Slots { get; set; }
        public DbSet<Project> Workspaces { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Project>().HasData(
                new Project { Id = Guid.Parse("57594ca7-a447-4e3b-b894-c971f3e6821b"), Title = "HCA Website", Name = "hca", DisplayOrder = 50 },
                new Project { Id = Guid.Parse("1a485ecf-ccb4-4921-b323-ad4e61d7b224"), Title = "Skilled Guru", Name = "skilled-guru" }
                );

            modelBuilder.Entity<Environment>().HasData(
             new Environment { IsEditable = false, WorkspaceId = Guid.Parse("57594ca7-a447-4e3b-b894-c971f3e6821b"), Id = Guid.Parse("127febed-3f95-4d43-9d91-ea1e15452a13"), Hostname = "hca.local", Title = "Production", Name = "prod", DisplayOrder = 50 },
             new Environment { IsEditable = true, WorkspaceId = Guid.Parse("57594ca7-a447-4e3b-b894-c971f3e6821b"), Id = Guid.Parse("f7c2b760-c763-4a9d-a5e0-5e72c5e22d6b"), Hostname = "dev.hca.local", Title = "Development", Name = "dev" }
             );
