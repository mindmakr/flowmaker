...
namespace flowmaker.web.Migrations
{
    ...
    [Migration("20200906083050_InitSetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("flowmaker.models.Flow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("flowmaker.models.FlowInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("flowmaker.models.Slot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("flowmaker.models.ViewPage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("flowmaker.models.Workspace", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("flowmaker.models.FlowInstance", b =>
                {
                    b.HasOne("flowmaker.models.Flow", "Flow")
                        .WithMany()
                        .HasForeignKey("FlowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("flowmaker.models.Slot", "Slot")
                        .WithMany()
            ...
            modelBuilder.Entity("flowmaker.models.Slot", b =>
                {
                    b.HasOne("flowmaker.models.Workspace", "Workspace")
